...
namespace Attendance.Model
{
    public class StaffOfficial
    {
        ...
        public bool IsEarlyConfirmation { get; set; }
        public bool IsLateConfirmation { get; set; }
    }
    ...
    public class StaffOfficialInformation
    {
        ...
        public string AutoShift { get; set; }
        public string GeneralShift { get; set; }
        public string ShiftPattern { get; set; }
        public string FlexiShift { get; set; }
        public string ManualShift { get; set; }
        public string ShiftId { get; set; }
        public int ShiftPatternId { get; set; }
        public string WorkStationId { get; set; }
        public int ApproverLevel { get; set; }
