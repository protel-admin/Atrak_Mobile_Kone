...
namespace Attendance.Repository
{
    public class AttendanceManagementContext : DbContext
    {
        ...
        public DbSet<MobileSwipeTransaction> MobileSwipeTransactions { get; set; }

        public DbSet<DashboardSwipes> DashboardSwipes { get; set; }

        public DbSet<PunchTypeHistory> PunchTypeHistory { get; set; }
...
.HasDatabaseGeneratedOption(DatabaseGeneratedOption.Identity);
            ...
            modelBuilder.Entity<DashboardSwipes>().Property(r => r.Id).HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);

            modelBuilder.Entity<PunchTypeHistory>().Property(r => r.StaffId).HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);
